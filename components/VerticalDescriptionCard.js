...
export default function VerticalDescriptionCard({card, position}) {
  ...
  return (
    <div className='rounded-2xl bg-white shadow-md p-7 grid md:grid-rows-[1.5fr_4fr_1fr] gap-5 font-karla'>
      ...
      <button data-card-number={position} className='text-lg xl:text-[30px] text-white font-medium flex justify-around items-center gap-3 rounded-md px-4 lg:px-7 py-2'>
        <div>
