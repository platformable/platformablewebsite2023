...
export default function SocialProof({data, colorScheme}) {
  ...
  return (
   <>
    ...
    <section className=" py-10 md:py-14" style={{background:colorScheme.testimonials.testimonialSectionBgColor}}>
      ...
      <div className={`md:grid grid-cols-2  gap-5  hidden`} ref={slidesRef}>
