...
const Meta = ({ title, keywords, description,data }) => {
  return (
      ...
      <Head>
        ...
        <meta name="twitter:image" content={data?.featured_img?.data.attributes?.formats.thumbnail.url} />

        {/* Open Graph Meta Tags */}
        <meta property="og:title" content={data?.title} />
        <meta property="og:description" content={data?.excerpt.replace(/(<([^>]+)>)/gi, '')} />
        <meta property="og:type" content="website" />
        <meta property="og:image" content={data?.featured_img?.data.attributes?.formats.thumbnail.url} />
        <meta property="og:image:secure_url" content={data?.featured_img?.data.attributes?.formats.thumbnail.url} />
