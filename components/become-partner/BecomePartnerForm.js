...
export default function BecomePartnerForm({ apiKey }) {
  ...
  return (
    <div
      id="left-column"
      className="w-[70%] justify-self-end px-3 md:px-10 lg:px-8 py-10 bg-gradient-to-b from-[var(--purple-medium)] to-[#301BBD] rounded-xl"
    >
      ...
      >
        ...
        <div>
          <label>
            <small className="text-white">Your Email</small>
