        ...
        <article className="py-10 ">
          <div className="content-header text-[var(--purple-extra-dark)] container mx-auto ">
            ...
            <section className="">
              ...
              <div>
                <span className="text-[var(--purple-extra-dark)]">
                  Written by{" "}
                </span>
                {data?.teams?.data.map((team, index) => (
                  <span
                    key={index}
                    className="font-bold text-[var(--purple-extra-dark)]"
                  >
            ...
            {data?.featured_img && (
              <center>
                {" "}
                <img
                  src={data?.featured_img?.data?.attributes?.url}
                  alt="featured image"
                  className="pt-14 pb-4 w-2/4"
                />
              </center>
            )}
          </div>
          ...
          <div className="container mx-auto gap-x-3 pt-10 pb-16">
            ...
            <div className="grid lg:grid-cols-3 gap-x-10 gap-y-7">
              {relatedSectorPosts?.map((post, index) => {
                if (index <= 2) {
                  return (
                    <BlogPreviewCard post={post} key={index} draft={false} />
                  )
                } else {
                  null
                }
